...
<link href="${url }/ShopLaptop/views/admin/assetss/css/manager.css"
...
<body>
	<div class="container">
	<a href="/ShopLaptop/Home" class="btn btn-danger" data-toggle="modal"> <span> < Back Home</span></a>
				...
				<tbody>
					<c:forEach items="${requestScope.listP}" var="o">
						<tr>
							...
							<td>${o.price}$</td>
							<td><a href="update?pid=${o.id }" class="edit"
